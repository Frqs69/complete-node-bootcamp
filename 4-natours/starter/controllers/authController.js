...
exports.isLoggedIn = async (req, res, next) => {
  try {
    ...
    if (req.cookies.jwt) {
      ...
      res.locals.user = currentUser; // pass data to pug templates
    }
  } catch (err) {
    return next();
  }
...
// we cant pass argument to middleware function so we create function which returns
// middleware function which will have access to argument given function above
